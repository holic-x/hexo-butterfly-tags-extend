...
function genGithubRepoTag(args,content) {
                ...
                <div class="gr-card">
                    ...
                    <div class="gr-content">
                        <div class="gr-fullname">
                            <p><i class="fab fa-github fa-lg" aria-hidden="true" id="gr-github-icon"></i> ${
                              data.full_name
                            }</p>
                        </div>
                    ...
                    <div class="gr-footer">
                        <div class="gr-language-star">
                            ...
                            <i class="far fa-star" aria-hidden="true" id='gr-star-icon'> ${unit(
